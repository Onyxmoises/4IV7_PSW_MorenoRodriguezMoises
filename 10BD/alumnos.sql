...
CREATE TABLE `alumnobatiz` (
  ...
  KEY `nombre` (`nombre`),
  KEY `appat` (`appat`)
) ENGINE=InnoDB AUTO_INCREMENT=2021090562 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `alumnobatiz` VALUES (1,'Onyx','Moises',' ','3035');
...
-- Dump completed on 2022-04-01  1:58:52
